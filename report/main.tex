...
\noindent\LARGE\textbf{Título do estágio muito grande e em pormenor\\\\}
\Large{Licenciatura em Eng. Informática\\}
\large{Estágio-Projecto 2020-2021\\}
\end{minipage}
...
\vspace{0.5cm}
\noindent\large\textbf{Nome do aluno\\}

\noindent
Orientador na empresa:\\     
Orientador no departamento:

\emph{\\Trabalho desenvolvido na empresa xxxx no âmbito da disciplina de Estágio-Projeto da Licenciatura em Eng. Informática.}\\ 
